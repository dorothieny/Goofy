class TypesController < ApplicationController
  ...
  def index
    @types = Type.all
    render component: 'Types_Table', props: { types: @types }
  end

  # GET /types/1 or /types/1.json
  def show
    render component: 'M_Typeview', props: { type: @type }
  end
  ...
  private
    ...
    def type_params
      params.require(:type).permit(:name, :description, :display_in_navbar)
    end
end
